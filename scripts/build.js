...
<head>
  ...
  <meta name="sogou_site_verification" content="oBgzBSJoP6" />
      ...
      <section class="hero">
        ...
        <div class="container">
          <figure class="hero-banner-figure">
            <img src="${relative('/', '/assets/hero-entrance.jpg')}" alt="燃灯寺公墓大门头与服务大楼实景" loading="eager" width="1200" height="675">
            <figcaption>燃灯寺公墓大门头与服务大楼实景</figcaption>
          </figure>
        </div>
      </section>
